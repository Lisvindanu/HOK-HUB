...
import { Menu, X, ChevronDown, LogOut, LogIn, LayoutDashboard, BarChart3, Shield, Trophy, UserPlus, Home, Users, Layers, Sparkles, Zap, CreditCard, Swords, Gem, Target, Map, Music2, Combine } from 'lucide-react';
            ...
            <div className="md:hidden fixed inset-0 z-[101]">
              ...
              <div className="overflow-y-auto h-[calc(100vh-4rem)] pb-20 bg-[#0a0e27]">
                <div className="p-4 space-y-2">
                  ...
                  {isAuthenticated && user && (
                    <>
                      <p className="text-xs text-gray-500 uppercase tracking-wider px-2 pt-6 pb-2">Account</p>
                      <div className="space-y-1">
                        <Link
                          to="/dashboard"
