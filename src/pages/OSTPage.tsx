...
const ALBUMS: Album[] = [
  {
    ...
    tracks: [
      { no: 1,  title: 'Born to Rise',              artist: 'Honor of Kings',              duration: '3:34', youtubeId: 'HaIKxmA5Jso' },
      { no: 2,  title: 'Atlas of Tomorrow',          artist: 'JJ Lin feat. Taeil',          duration: '4:44', youtubeId: 'Ra6tyMqBoss' },
      { no: 3,  title: 'Main Theme',                 artist: 'Hans Zimmer & Lorne Balfe',   duration: '4:02', youtubeId: 'HVXQp5KTAJU' },
      { no: 4,  title: 'Burn The Flame',             artist: 'SB19 × Honor of Kings',       duration: '3:05', youtubeId: 'JqGobBBBHqQ' },
      { no: 5,  title: 'Evolve',                     artist: 'Honor of Kings',              duration: '3:18', youtubeId: 'ILorcS1LId4' },
      { no: 6,  title: 'True Hertz',                 artist: 'Honor of Kings',              duration: '3:12', youtubeId: 'oyoTd1lLVew' },
      { no: 7,  title: 'Invincible',                 artist: 'Honor of Kings',              duration: '3:28', youtubeId: 'xvCOfPwEdAM' },
      { no: 8,  title: 'The Contender',              artist: 'Honor of Kings',              duration: '3:12', youtubeId: 'WP1G80IwkTE' },
    ],
  ...
  },
  {
    ...
    cover: 'https://img.youtube.com/vi/ZuR9h4CWGw8/maxresdefault.jpg',
    tracks: [
      { no: 1,  title: "Chang'an City",              artist: 'Howard Shore',                duration: '5:11', youtubeId: 'ZuR9h4CWGw8' },
      { no: 2,  title: 'First War & Second War',     artist: 'Hans Zimmer & Lorne Balfe',   duration: '6:04', youtubeId: 'HVXQp5KTAJU' },
      { no: 3,  title: 'Chu-Han',                    artist: 'Marcin Przybyłowicz',         duration: '4:48', youtubeId: 'x6OXHVSpQGY' },
      { no: 4,  title: 'Guardians of the Great Wall',artist: 'Marcin Przybyłowicz',         duration: '4:22', youtubeId: '7mbabKqph2M' },
      { no: 5,  title: 'Big Creature',               artist: 'Hans Zimmer & Lorne Balfe',   duration: '3:55', youtubeId: 'HVXQp5KTAJU' },
  ...
  },
  {
    ...
    tracks: [
      ...
      { no: 4,  title: 'Haya Champion Theme',        artist: 'Honor of Kings',              duration: '3:08', youtubeId: 'iG1i--PNctQ' },
      ...
      { no: 7,  title: 'Limbo Theme',                artist: 'Honor of Kings',              duration: '3:19', youtubeId: 'ouq8enrxx7c' },
  ...
  },
  {
    ...
    cover: 'https://img.youtube.com/vi/N_6oFbVew1U/maxresdefault.jpg',
    tracks: [
      { no: 1,  title: 'Dragon of Rites',            artist: 'Zhao Yun · CNY 2024',        duration: '3:21', youtubeId: 'jeFQ07xfSBY' },
      { no: 2,  title: 'Dragon of Protection',       artist: 'Sun Ce',                      duration: '3:18', youtubeId: '5lvWfm9yvuI' },
      { no: 3,  title: 'Dragon of Divination',       artist: 'Sun Shangxiang',              duration: '3:12', youtubeId: 'Qra90ysFa1g' },
      { no: 4,  title: 'Dragon of Artistry',         artist: 'Da Qiao',                     duration: '3:05', youtubeId: 'RNiaEYQIGC8' },
      { no: 5,  title: 'Dragon of Voyages',          artist: 'Angela',                      duration: '3:28', youtubeId: 'kl_xWEJ3Y4k' },
      { no: 6,  title: 'Lullaby of the Sea',         artist: 'Honor of Kings',              duration: '3:44', youtubeId: 'N_6oFbVew1U' },
      { no: 7,  title: 'Amber Era Theme',            artist: 'Honor of Kings',              duration: '3:15', youtubeId: 'qsmFIPcTEUQ' },
      { no: 8,  title: 'Snow Carnival Theme',        artist: 'Honor of Kings',              duration: '3:02', youtubeId: 'jLIxQu3PF9Y' },
      { no: 9,  title: 'Jujutsu Kaisen × HOK',      artist: 'Biron × Kongming',            duration: '2:55', youtubeId: 'ptvReXJxAFI' },
      { no: 10, title: '2024 Global Launch Lobby',   artist: 'Honor of Kings',              duration: '3:38', youtubeId: 'NbvwBWnn48A' },
    ],
    youtubeUrl: 'https://www.youtube.com/@HonorofKingsAudioTeam',
  },
];
