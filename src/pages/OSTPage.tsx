...
const ALBUMS: Album[] = [
  {
    ...
    tracks: [
      ...
      { no: 8,  title: 'The Contender',              artist: 'Honor of Kings',              duration: '3:27', youtubeId: '59k-tnitF5s' },
    ],
  ...
  },
  {
    ...
    tracks: [
      ...
      { no: 7,  title: 'Amber Era',                  artist: 'Honor of Kings',              duration: '5:23', youtubeId: 'T_i0_dZ0gkE' },
