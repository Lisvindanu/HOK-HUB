...
const ALBUMS: Album[] = [
  ...
  },
  {
    ...
    tracks: [
      ...
      { no: 4,  title: 'Dragon of Artistry',         artist: 'Da Qiao',                     duration: '3:05', youtubeId: 'VndpP2grwyE' },
      { no: 5,  title: 'Dragon of Voyages',          artist: 'Angela',                      duration: '3:28', youtubeId: 'GtyqCPBS2oA' },
