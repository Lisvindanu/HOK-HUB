...
const PHASES: Phase[] = [
  {
    ...
    icon: Rocket,
    milestones: [
      { label: 'Platform HOK Hub — launch awal' },
  ...
  },
  {
    ...
    milestones: [
      ...
      { label: 'Arcana Explorer — detail set arcana' },
  ...
  },
  {
    ...
    milestones: [
      ...
      { label: 'Trakteer widget — support HOK Hub' },
    ],
  },
  {
    num: '05',
...
const COMING_NEXT = [
  ...
  },
  {
    ...
    desc: 'Pantau rank dan statistik match kamu langsung dari HOK Hub',
    icon: Target,
  },
];
